    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row  gap-5 '>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-5 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* -------------Doc Info--------------- */}
          <p className='flex items-center gap-2 text-2xl font font-medium text-gray-900'>{docInfo.name} <img className='w-4' src={assets.verified_icon} alt="" /></p>
          ...
          {/* --------------Doctor About-------------------- */}
          <div >
            <p className='flex items-center gap-1 text-sm font-medium text-gray-900 mt-3'>Giới thiệu <img className='w-3.5' src={assets.info_icon} alt="" /></p>

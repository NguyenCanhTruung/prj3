  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12 items-center justify-center'>
        <img className='w-full md:max-w-[360px] rounded animate-fade-slide-up-2' src={assets.about_image} alt="" />
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600 animate-fade-slide-up-3'>
      ...
      <div>
        <div className='indent-0 md:indent-32 text-xl my-4'>
          <p className='animate-fade-slide-up-2_2'>VÌ SAO <span className='text-gray-700 font-semibold'>CHỌN CHÚNG TÔI</span> </p>
        </div>

        <div className='flex flex-col md:flex-row mb-20 animate-fade-slide-up'>
          <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[-15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 rounded-l-lg'>
            <b>Hiệu quả</b>
          ...
          <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[-15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 rounded-r-lg'>
            <b>Cá nhân hóa</b>
